...
export async function TranferColor(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>) {
...
export async function TransferColorProvided(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, providedImgArr: Uint8Array) {
    const start = performance.now();
