...
export async function Saturation(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, value: number[]) {
...
export async function Temperature(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, value: number[]) {
    const start = performance.now();
...
export async function Tint(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, value: number[]) {
    const start = performance.now();
