...
export async function ExposureNative(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, value: number[]) {
...
export async function ContrastNative(hook: ReturnType<typeof useImageEditor>, benchmarkHook: ReturnType<typeof useBenchmarkHook>, value: number[]) {
    console.time("Adjust Tint Native finish in");
    const start = performance.now();
